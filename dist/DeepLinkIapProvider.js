...
const DeepLinkIapProvider = ({ children, }) => {
    ...
    const reportAffiliateAssociationIfNeeded = (affiliateIdentifier, source) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetch('https://edef339eb7d5.ngrok-free.app/V1/onboarding/affiliate-associated', {
                method: 'POST',
                headers: {
    ...
    const reportSdkInitIfNeeded = (companyCode, verboseLogging) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetch('https://edef339eb7d5.ngrok-free.app/V1/onboarding/sdk-init', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const storeExpectedStoreTransaction = (purchaseToken) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const response = yield fetch("https://edef339eb7d5.ngrok-free.app/v1/api/app-store-webhook/create-expected-transaction", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const trackEvent = (eventName) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const response = yield axios_1.default.post('https://edef339eb7d5.ngrok-free.app/v1/trackEvent', payload, {
